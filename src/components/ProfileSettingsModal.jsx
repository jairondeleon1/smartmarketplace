        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex gap-3 items-start">
            ...
            <label htmlFor="disclaimer-accept" className="text-xs text-amber-900 leading-relaxed cursor-pointer">
              I understand that SmartMenuIQ provides <span className="font-bold">estimates only</span>, and I am responsible for verifying ingredient and allergen information directly with the  Ingredient Ambassador at the Cafe/Marketplace before consuming any item.
            </label>
          </div>
