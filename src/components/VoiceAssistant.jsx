...
export default function VoiceAssistant({ menuItems = [] }) {
  ...
  const startListening = useCallback(() => {
    ...
    rec.onresult = async (e) => {
      ...
      try {
        const slimMenu = menuItems.map(({ name, day, station, meal_period, calories, protein, carbs, description, tags }) => ({
          name, day, station, meal_period, calories, protein, carbs, description, tags
        }));
